...
function About() {
  return (
    <div className="body">
    <h1 className="words"> About </h1>
    <p className="words">Hello, I'm Soumitri - a photographer based in Singapore who focuses on
                          photographing humans, food and products.</p>
